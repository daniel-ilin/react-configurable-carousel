...
function useSwipeable(options) {
    ...
    const transientState = react.exports.useRef(Object.assign({}, initialState));
    const transientProps = react.exports.useRef(Object.assign({}, defaultProps));
    // track previous rendered props
    const previousProps = react.exports.useRef(Object.assign({}, transientProps.current));
    ...
    const [handlers, attachTouch] = react.exports.useMemo(() => getHandlers((stateSetter) => (transientState.current = stateSetter(transientState.current, transientProps.current)), { trackMouse }), [trackMouse]);
...
const Carousel = (props) => {
    ...
    const [showingIndex, setShowingIndex] = react.exports.useState(0);
    const [showItems, setShowItems] = react.exports.useState();
    const [waiting, setWaiting] = react.exports.useState(false);
    const [autoScrollClickDelay, setAutoScrollClickDelay] = react.exports.useState(false);
    ...
    const shiftLeft = react.exports.useCallback(() => {
    ...
    const shiftRight = react.exports.useCallback(() => {
        setShowingIndex((prev) => {
    ...
    const rotateCarouselHandler = react.exports.useCallback((arg0) => {
        if (waiting === false) {
            setWaiting(true);
            switch (arg0) {
                case "L":
